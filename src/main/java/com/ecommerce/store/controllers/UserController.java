...
import com.ecommerce.store.dtos.ImageResponse;
import com.ecommerce.store.dtos.PageableResponse;
import com.ecommerce.store.dtos.UserDto;
import com.ecommerce.store.services.FileService;
...
@Api(value = "UserController", tags = "REST APIs related to perform user operations !!")
// @CrossOrigin("*")
public class UserController {
    ...
    public ResponseEntity<ApiResponseMessage> assignAdminRole(@PathVariable String userId) {
